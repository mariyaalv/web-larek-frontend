...
export class FormContacts extends Form<TFormOfContact> implements IFormOfContact {
  ...
  constructor(protected container: HTMLFormElement, events: IEvents) {
    ...
    this.inputPhone = this.container.elements.namedItem('email') as HTMLInputElement;
  }
